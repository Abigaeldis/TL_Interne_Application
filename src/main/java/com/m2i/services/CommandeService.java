...
import com.m2i.repositories.CommandeRepository;
...
//		}
	...
	public List<Commande> getCommandsByTableAndStatut(Table table, String statut) {
	    return commandeRepo.findByTableNumTableAndTableRestaurantIdAndStatut(table.getNumTable(), table.getRestaurant().getId(), statut);
	}

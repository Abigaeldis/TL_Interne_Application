...
VALUES 
    (1, 'Doe', 'John', 'john.doe@email.com', 'lion', '0612345678', '123 Rue des exemples', 'client', NULL, NULL, 1),
    (2, 'Smith', 'Alice', 'alice.smith@email.com', 'tiger', '0723456789', '456 Avenue des tests', 'employe', NULL, NULL, 1),
    (3, 'Brown', 'Emma', 'emma.brown@email.com', 'elephant', '0634567890', '789 Boulevard des données', 'manager', NULL, NULL, 2),
    (4, 'Dupont', 'Alice', 'alice.dupont@email.com', 'giraffe', '0745678901', '1 Rue de l''exemple', 'client', NULL, NULL, 1),
    (5, 'Martin', 'Paul', 'paul.martin@email.com', 'zebra', '0656789012', '2 Avenue des tests', 'client', NULL, NULL, 2);
...
VALUES
    (1, CONVERT(DATETIME,'2024-04-01 12:00:00',120), 'Confirmée', 2, 1, 1, 1),
    (2, CONVERT(DATETIME,'2024-04-01 19:00:00',120), 'En attente', 4, 2, 2, 1),
    (3, CONVERT(DATETIME,'2024-04-02 18:00:00',120), 'Confirmée', 3, 3, 3, 1),
    (4, CONVERT(DATETIME,'2024-04-02 20:30:00',120), 'Annulée', 2, 4, 4, 1),
    (5, CONVERT(DATETIME,'2024-04-03 12:30:00',120), 'Confirmée', 1, 5, 5, 1),
    (6, CONVERT(DATETIME,'2024-04-03 18:00:00',120), 'Confirmée', 2, 1, 1, 1),
    (7, CONVERT(DATETIME,'2024-04-03 19:30:00',120), 'En attente', 2, 2, 2, 1),
    (8, CONVERT(DATETIME,'2024-04-04 18:00:00',120), 'Confirmée', 3, 3, 3, 1),
    (9, CONVERT(DATETIME,'2024-04-04 20:00:00',120), 'Confirmée', 4, 4, 4, 1),
    (10, CONVERT(DATETIME,'2024-04-05 19:00:00',120), 'Annulée', 5, 5, 5, 1),
    (11, CONVERT(DATETIME,'2024-04-05 21:30:00',120), 'Confirmée', 2, 1, 1, 1),
    (12, CONVERT(DATETIME,'2024-04-06 12:00:00',120), 'Confirmée', 3, 2, 2, 1),
    (13, CONVERT(DATETIME,'2024-04-06 17:00:00',120), 'En attente', 4, 3, 3, 1),
    (14, CONVERT(DATETIME,'2024-04-06 19:30:00',120), 'Confirmée', 1, 4, 4, 1),
    (15, CONVERT(DATETIME,'2024-04-06 21:00:00',120), 'Confirmée', 2, 5, 5, 1),
    (16, CONVERT(DATETIME,'2024-04-01 13:00:00',120), 'En attente', 3, 1, 1, 1),
    (17, CONVERT(DATETIME,'2024-04-02 14:00:00',120), 'Confirmée', 2, 2, 2, 1),
    (18, CONVERT(DATETIME,'2024-04-03 15:30:00',120), 'Confirmée', 4, 3, 3, 1),
    (19, CONVERT(DATETIME,'2024-04-04 16:30:00',120), 'En attente', 1, 4, 4, 1),
    (20, CONVERT(DATETIME,'2024-04-05 17:30:00',120), 'Confirmée', 3, 5, 5, 1);
